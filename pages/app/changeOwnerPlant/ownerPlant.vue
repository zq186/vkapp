...
<script>
	 ...
	 */
	var provinces=[{"label":"Training","value":"11"},{"label":"Owner1","value":"12"}];
	var citys=[[{"label":"Plant1","value":"1101"},{"label":"Plant2","value":"1102"},{"label":"Plant3","value":"1103"}],[{"label":"Plant1","value":"1201"}],[{"label":"石家庄市","value":"1301"}]];
	export default {
		name: 'u-city-select',
		props: {
			// 通过双向绑定控制组件的弹出与收起
